...
public class AvailabilityDAOTest {
    ...
    @Test void testGetAvailabilityByStudent() {
    ...
    @Test void testMultipleAvailabilityEntries() {
        availabilityDAO.addAvailability(new Availability(0, studentId,
    ...
    @Test void testInvalidTimeRange() {
    ...
    @Test void testDeleteAvailability() {
        Availability a = new Availability(0, studentId,
    ...
    @Test void testAvailabilityOverlapsAllowed() {
        availabilityDAO.addAvailability(new Availability(0, studentId,
    ...
    @Test void testEmptyAvailabilityListForNewStudent() {
        assertTrue(availabilityDAO.getAvailabilityByStudent(-1).isEmpty());
    }

    @Test void testStartEqualsEndTime() {
        Availability a = new Availability(0, studentId,
    ...
    @Test void testAvailabilityPersistenceAcrossFetches() {
        Availability a = new Availability(0, studentId,
    ...
    @Test void testDeleteNonexistentAvailability() {
